/datum/admins/Topic(href, href_list)
	...
	if(href_list["makeAntag"])
		...
		switch(href_list["simplemake"])
			...
			if("praetorian")		M.change_mob_type( /mob/living/carbon/alien/humanoid/sentinel , null, null, delmob )
			if("ravager")			M.change_mob_type( /mob/living/carbon/alien/humanoid/sentinel , null, null, delmob )
			if("spitter")			M.change_mob_type( /mob/living/carbon/alien/humanoid/sentinel , null, null, delmob )
			...
			if("hivelord")			M.change_mob_type( /mob/living/carbon/alien/humanoid/sentinel , null, null, delmob )
			if("carrier")			M.change_mob_type( /mob/living/carbon/alien/humanoid/sentinel , null, null, delmob )
